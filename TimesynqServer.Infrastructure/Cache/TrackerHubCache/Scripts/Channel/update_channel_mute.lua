...
-- UserId, Frame, Channel, IsOn, UpdatedOnUTC
...
local old_on_mask = redis.call("HGET", frame_key, frame_field_names.on_mask)
local old_on_mask_short = tonumber(old_on_mask, 16)
