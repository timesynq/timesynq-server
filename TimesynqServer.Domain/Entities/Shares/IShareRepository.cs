...
namespace TimesynqServer.Domain.Entities.Shares
{
    public interface IShareRepository
    {
        ...
        public Task<int> GetSharedUserCountAsync(Guid wipId, string? searchString);
        public Task<int> GetSharedWipCountAsync(Guid sharedWithId, string? searchString);
        public Task<IEnumerable<UserProjection>> GetSharedUsersByWipAsync(Guid wipId, string? searchString, int pageNumber, int pageSize, SortOrder sortOrder, ShareSortBy sortBy);
        public Task<IEnumerable<WipProjection>> GetSharedWipsByUserAsync(Guid sharedWithId, string? searchString, int pageNumber, int pageSize, SortOrder sortOrder, ShareSortBy sortBy);
