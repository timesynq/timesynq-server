...
namespace TimesynqServer.Migrations
{
    ...
    [Migration("20250815233450_SoftDelete")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TimesynqServer.Domain.Entities.Follow", b =>
                {
            ...
            modelBuilder.Entity("TimesynqServer.Domain.Entities.TimesynqUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("TimesynqServer.Domain.Entities.TimesynqUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TimesynqServer.Domain.Entities.Follow", b =>
                {
                    b.HasOne("TimesynqServer.Domain.Entities.TimesynqUser", "Followee")
                        .WithMany("Followers")
                        .HasForeignKey("FolloweeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TimesynqServer.Domain.Entities.TimesynqUser", "Follower")
                        .WithMany("Following")
